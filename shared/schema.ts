...
import { pgTable, text, varchar, integer, boolean, timestamp, jsonb, json, uniqueIndex, index } from "drizzle-orm/pg-core";
...
// Session table — owned at runtime by connect-pg-simple (tableName:'session', createTableIfMissing:true).
// Defined here solely so drizzle-kit tracks it and never drops it during schema pushes.
